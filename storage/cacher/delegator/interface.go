...
import (
	...
	"go.etcd.io/cache/storage"
	etcdfeature "go.etcd.io/cache/storage/feature"
...
// Function is located here to avoid import cycles between staging/src/go.etcd.io/cache/storage/cacher/delegator.go and staging/src/k8s.io/apiserver/pkg/util/flow_control/request/list_work_estimator.go.
